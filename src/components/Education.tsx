...
function Education({ title, name, year, major, TitleIcon }: EducationProps): ReactElement {
  return (
    <div className="">
      {/* title, name, year */}
      <div className="flex gap-3 items-start justify-start">
        ...
        <div className="flex flex-col gap-3 items-start justify-start">
          ...
          {/* name */}
          <h2 className="text-lg md:text-xl font-medium text-white/60">{name}</h2>
          <h3
            className="flex gap-2 justify-center items-center text-sm md:text-lg font-medium tracking-tight
            text-slate-400"
          >
